# Comando *history*
Este comando es útil para visualizar el historial de comandos ejecutados en la terminal con el propósito de revisar o repetir lo que has ejecutado en la terminal recientemente. 
...
!101:p
~~~
Y en la salida podremos visualizar el comando que corresponde a ese número sin ser ejecutado.
