...
~~~
tail -v BRCA1transcript.txt
~~~
O bien, si queremos visualizar los mismos datos de varios archivos: 
~~~
tail -v BRCA1transcript.txt BRCA2transcript.txt PALB2transcript.txt
~~~
Igualmente lo podemos combinar con la opción -n u otras: 
~~~
tail -v -n 6 BRCA1transcript.txt BRCA2transcript.txt PALB2transcript.txt
~~~
...
~~~
tail -q BRCA1transcript.txt BRCA2transcript.txt PALB2transcript.txt
~~~