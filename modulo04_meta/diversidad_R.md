...
* En esta práctica ocuparemos del lenguaje de programación R para implementar diversos paquetes, algunos de ellos vistos en actividades anteriores para retroalimentarnos.
